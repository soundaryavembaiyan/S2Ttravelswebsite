...
<body>
	<center>
		...
		$sql = "INSERT INTO message VALUES ('$query')";
		
		if(mysqli_query($conn, $sql)){
			echo "<h3>YOUR QUERY IS SENDED SUCCESSFULLY";
...
<center><font color="black" size="20">We will check your query soon:)...</font></center>
</marquee>
	<form action="s2t.php">
